...
"""Validate validation-only UPS advection h16 training-candidate evidence."""
...
DEFAULT_EVIDENCE_JSON = "docs/claim_evidence/ups_advection_h16_candidate_val_evidence.json"
EXPECTED_MEASUREMENT_TYPE = "ups_advection_h16_training_candidate_validation"
EXPECTED_DECISION_STATUS = "phase_gate_not_cleared_h16_training_candidate"
METRICS_TO_RECORD = (
