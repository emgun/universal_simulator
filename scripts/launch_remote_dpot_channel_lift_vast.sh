...
# Dry-run-first Vast launcher for the P2 DPOT Tiny channel-lift validation.
#
...
# contains scripts/run_remote_dpot_channel_lift.sh.
...
PIPELINE_ROOT=${PIPELINE_ROOT:-reports/demo/remote_dpot_channel_lift}
REMOTE_SCRIPT=${REMOTE_SCRIPT:-scripts/run_remote_dpot_channel_lift.sh}
