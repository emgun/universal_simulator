...
REMOTE_SCRIPT=${REMOTE_SCRIPT:-scripts/run_remote_model_side_beta_head_pretest.sh}
...
args=(
  ...
  --script-args "DRY_RUN=0 ALLOW_HELDOUT_PRETEST=${ALLOW_HELDOUT_PRETEST} ENV_FILE=.env $EXTRA_PIPELINE_ARGS"
)
